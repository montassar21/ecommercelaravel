        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="blog__item">
                        <div class="blog__item__pic set-bg"
                            data-setbg="{{ asset('mainassets/img/blog/blog-1.jpg') }}"></div>
                        <div class="blog__item__text">
                            <span><img src="{{ asset('mainassets/img/icon/calendar.png') }}" alt=""> 16
                                February 2020</span>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="blog__item">
                        <div class="blog__item__pic set-bg"
                            data-setbg="{{ asset('mainassets/img/blog/blog-2.jpg') }}"></div>
                        <div class="blog__item__text">
                            <span><img src="{{ asset('mainassets/img/icon/calendar.png') }}" alt=""> 21
                                February 2021</span>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="blog__item">
                        <div class="blog__item__pic set-bg"
                            data-setbg="{{ asset('mainassets/img/blog/blog-3.jpg') }}"></div>
                        <div class="blog__item__text">
                            <span><img src="{{ asset('mainassets/img/icon/calendar.png') }}" alt=""> 28
                                February 2022</span>
